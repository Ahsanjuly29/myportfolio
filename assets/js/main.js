...
(function ($) {
    ...
    jQuery(document).ready(function($){
        ...
        $("span.color_1").on("click", function(){
            $("body").addClass("color_1_theme").removeClass("color_2_theme color_3_theme color_4_theme color_5_theme");
        });
        $("span.color_2").on("click", function(){
            $("body").addClass("color_2_theme").removeClass("color_1_theme color_3_theme color_4_theme color_5_theme");
        });
        $("span.color_3").on("click", function(){
            $("body").addClass("color_3_theme").removeClass("color_1_theme color_2_theme color_4_theme color_5_theme");
        });
        $("span.color_4").on("click", function(){
            $("body").addClass("color_4_theme").removeClass("color_1_theme color_3_theme color_2_theme color_5_theme");
        });
		$("span.color_5").on("click", function(){
            $("body").addClass("color_5_theme").removeClass("color_1_theme color_2_theme color_3_theme color_4_theme");
        });
